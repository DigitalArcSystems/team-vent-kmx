...
'EncoderCountsAbsolute = b3(Height^3) + b2(Height^2)+ b1(Height) + a_shift
'a_off = INT + ((SetLoad - BaseLoad) x Shift)) 
'	.ini EncoderCountsAbsolute_intercept = defined by the encoder count value at which we choose to set-home-zero height
